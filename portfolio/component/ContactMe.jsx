            ...
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                ...
                <span className="inline-flex">
                  <a className="ml-4 text-gray-500" href="https://x.com/RawatMilan027" target='blank'>
                    <svg
                      fill="currentColor"
                      strokeLinecap="round"
                  ...
                  <a className="ml-4 text-gray-500" href="https://www.instagram.com/milanrawat27/" target='blank'>
                    <svg
                      fill="none"
                      stroke="currentColor"
                      strokeLinecap="round"
                  ...
                  <a className="ml-4 text-gray-500" href="https://www.linkedin.com/in/milan-02777-rt/">
                    <svg
                      fill="currentColor"
                      strokeLinecap="round"
                      strokeLinejoin="round"
