...
import bmvb from '../../assets/bmvbb.png'
    ...
    <>
      <div ref={educationRef} className="h-auto dark:bg-gray-900 mt-16 mb-16 box-border ">
        ...
        <div id="about" className="relative bg-white dark:bg-gray-900 overflow-hidden">
              ...
              <main className="mt-10 mx-auto max-w-7xl dark:bg-gray-900 px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div className="sm:text-center lg:text-left">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed dark:text-white">
                    I graduated with a Bachelor's degree in Computer Applications from Institute of Innovation in Technology and Management and completed my schooling at Balvantary Mehta Vidya Bhawan.
          ...
          {
            isDarkMode?<>
             <img className="h-72 rounded-xl md:h-72 lg:ml-20  lg:h-full  w-110 border-r-lime-100" src={milan} alt="Deepak Bisht" />
            </>:<>
            <img className="h-72  rounded-xl md:h-96 lg:h-full object-cover object-top w-full" src={milan} alt="Deepak Bisht" />
            </>
          }
          </div>
        </div>
      ...
      <div className="space-y-10 justify-center md:space-y-0 md:flex md:space-x-10">
        <div className="w-full md:w-1/2">
          <article className="overflow-hidden dark:shadow-lg dark:shadow-white rounded-lg  shadow hover:shadow-lg">
            <img alt="Balvantary Mehta Vidya Bhawan" src={bmvb} className="h-66 w-full object-cover" />
        ...
        <div className="w-full md:w-1/2">
          <article className="overflow-hidden dark:shadow-lg dark:shadow-white rounded-lg shadow hover:shadow-lg">
            <img alt="Maharaja Surajmal Institute" src={iitm} className="h-86  w-full object-cover"/>
            <div className="bg-white p-4 sm:p-6 dark:bg-gray-900">
